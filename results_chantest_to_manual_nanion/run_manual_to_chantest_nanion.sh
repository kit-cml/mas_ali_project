...
INPUT_FOLDER="results_tms_manual"
OUTPUT_FOLDER="results_sensitivity_manual"
LOG_DIR="logs_sensitivity_manual"
NUM_DRUGS=10
CPR=0.75
...
SENSITIVITY_FOLDER="results_sensitivity_manual"
OUTPUT_FOLDER="results_performance_evals_manual"
...
MAX_JOBS=12
ACCEPTED_MODELS_FOLDER="accepted_models_manual_latest"
SENSITIVITY_FOLDER="results_sensitivity_manual"
GET_CALIBRATION_FOLDER="results_get_calibration_drugs"
TMS_FOLDER="results_tms_manual"
OUTPUT_FOLDER="results_validate_calibration_drugs_manual_to_nanion"
LOG_DIR="logs_validate_calibration_drugs_manual_to_nanion"
mkdir $OUTPUT_FOLDER
...
GET_CALIBRATION_FOLDER="results_get_calibration_drugs"
TMS_FOLDER="results_tms_manual"
OUTPUT_FOLDER="results_validate_calibration_drugs_manual_to_chantest"
LOG_DIR="logs_validate_calibration_drugs_manual_to_chantest"
mkdir $OUTPUT_FOLDER
for tms_metrics_file in "$TMS_FOLDER"/tms_metrics_*_*.csv; do
  base_tms_name=$(basename "$tms_metrics_file")
  tms_name=${base_tms_name%%.*}
