...
INPUT_FOLDER="results_tms_chantest"
OUTPUT_FOLDER="results_sensitivity_chantest"
LOG_DIR="logs_sensitivity_chantest"
NUM_DRUGS=10
CPR=0.75
...
OUTPUT_FOLDER="results_performance_evals_chantest"
...
CURRENT_JOBS=0
TMS_FOLDER="results_tms_chantest"
INPUT_FOLDER="results_performance_evals_chantest"
